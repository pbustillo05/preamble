...
\begin{conjecture}[almost Lurie Claim 2.3.19] The $(\infty,1)$-category $(\infty,n)\textnormal{-}\Cat^{\textnormal{adj}}$ of $(\infty,n)$-categories with adjoints is a \textbf{coreflexive subcategory} of the $(\infty,1)$-category $(\infty,n)\textnormal{-}\Cat$ of (small) $(\infty,n)$-categories. We denote the coreflector by $\tau_{\textnormal{adj}}$.
\end{conjecture}
